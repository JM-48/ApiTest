    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> {})
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/checkout/**").hasAnyRole("CLIENT","ADMIN")
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/v1/productos/**").hasAnyRole("ADMIN","PROD_AD","VENDEDOR")
                        .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/v1/productos/**").hasAnyRole("ADMIN","PROD_AD","VENDEDOR")
